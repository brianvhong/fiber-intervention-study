...
plate.merge %>%
    ...
    theme_bw() +
        labs(y = "LCAT Activity Index", x = "Time Point")
```

## HDL-C correlation with LCAT (Pearson Correlation)
```{r}
# CHeck normality
...
my.rmc <- rmcorr(participant = subject, measure1 = norm.LCAT.ratio, measure2 = log_HDL,
dataset = plate.merge)
 my.rmc
 plot(my.rmc)
 
ggscatter(plate.merge, x = "norm.LCAT.ratio", y = "log_HDL", color = "subject",
   add = "reg.line",  # Add regressin line
   add.params = list(color = "blue", fill = "lightgray"), # Customize reg. line
   conf.int = TRUE # Add confidence interval
   ) + stat_cor(method = "pearson", label.x = 1.05, label.y = 5) +
        labs(y = "log(HDL)", x = "LCAT Activity Index")
